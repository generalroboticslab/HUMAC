...
namespace Examples.HideAndSeek
{
    public class AIAgentManager : MonoBehaviour
    {
        ...
        private int _numHiderAgents = 1;
        private int _numSeekerAgents = 2;
        ...
        {
            // _hiderAgents.ForEach(agent => agent._isActive = true);
            if (_connection.IsServer)
                _seekerAgents.ForEach(agent => agent._isActive = true);
            {
