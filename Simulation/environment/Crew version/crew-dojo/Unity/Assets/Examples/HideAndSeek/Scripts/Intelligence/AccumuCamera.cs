    ...
    public class AccumuCamera : MonoBehaviour
    {
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            if (IsEnabled)
            {
                ...
                var originalCullingMask = _envCamera.cullingMask;
                var originalClearFlags = _envCamera.clearFlags;
                ...
                // Debug.Log("Body Position:"+_playerBody.transform.position);
                ...
                // Change the camera culling mask to include only the "seeker" layer
                _envCamera.cullingMask = LayerMask.GetMask("Seeker");
                _envCamera.clearFlags = CameraClearFlags.Depth;

                _envCamera.targetTexture = destination;
                _envCamera.Render();
                _envCamera.targetTexture = prevEnvRT;

                _envCamera.cullingMask = originalCullingMask;
                _envCamera.clearFlags = originalClearFlags;
        ...
        public void ClearAccumulation()
        {
            ...
            // if (_fullCam != null)
            // {
            //     _fullCam.targetTexture = null;
                
            //     // Clear any other specific resources or states associated with _fullCam if needed
            // }
        }
    }
}