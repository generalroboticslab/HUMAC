from Dataloader.Hide_and_Seek_Dataset_real_teammate import HideandSeekDataset
import os
...
model = CustomResNet18(num_of_frames,num_seekers=3-1,rotation=False)
...
save_base_directory = f"Weights/Teammate_Encoder_{num_of_frames}frames_{step_ahead}step_ahead"
